...
function displayTable(html) { 
    ...
    modal.innerHTML = `
        <div id="modal" style="${styles}">
            ...
            ${html}
            <iframe width="560" height="315" src="https://www.youtube.com/embed/uVPoGMu3LQo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share;" allowfullscreen autoplay></iframe>
        </div>
    `;
